          ...
          <div className="col-sm-6 questions">
            ...
            <ul>
              ...
              <li>
                ...
                can reject receiving the package when the courier contacts you.
              </li>
              <li>
                You can create a return from your account if the order status is
                "Delivered".
              </li>
            </ul>
      ...
      <div>
        ...
        <div className="row">
          <div className="col-sm-4 step">
            <div class="text">
              <strong>1.</strong> From the list of Orders in your Jumia Account,
              Click
        ...
        <div class="note">
          <p>
            <strong> Note: </strong> For prepaid orders, you will be refunded to
            your{" "}
