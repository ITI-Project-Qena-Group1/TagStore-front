...
export const Home = () => {
  ...
  return (
    <>
      ...
      <TopSelling id={'cardContainer1'} title={<h4 className='d-flex justify-content-between px-2 py-1 align-items-center'>{homePageProductsCarouselTitle1}</h4>} titleBg={'inherit'} productsCard1={productsCards} />
