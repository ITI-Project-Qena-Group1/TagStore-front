                    ...
                    <Row className="py-3">
                        ...
                        <Container className="col-md-4 col-sm-6 mt-2">
                            <Container className="d-flex">
                                <div>
                                    <h1><GiAlliedStar className="f-icon rounded" /></h1>
                                </div>
                            ...
                            <Row className="d-flex mx-3" >
                                ...
                                <a target="_blank" href="https://play.google.com/store/apps/details?id=com.jumia.android&referrer=adjust_reftag%3DcdTxOjM" className="btn-outline-light rounded mx-2 ">
                    ...
                    <Row className="py-3">
                        <Container className="col-md-3 col-sm-6">
                            ...
                            <ul className="p-0">
                                ...
                                <li className="f-li"><Link to="#"> How to shop on Jumia? </Link></li>
                                <li className="f-li"><Link to="#">How to pay on Jumia?</Link></li>
                        ...
                        <Container className="col-md-3 col-sm-6">
                            ...
                            <ul className="p-0">
                                <li className="f-li"><Link to="#">Jumia Logistics Services</Link></li>
                                <li className="f-li"><Link to="#">Jumia Careers</Link></li>
                                <li className="f-li"><Link to="#">Terms and Conditions</Link></li>
                                <li className="f-li"><Link to="#">Privacy Policy</Link></li>
                                <li className="f-li"><Link to="#">Jumia Express</Link></li>
                                <li className="f-li"><Link to="#">Jumia Mall</Link></li>
                                <li className="f-li"><Link to="#">Flash Sales</Link></li>
                                <li className="f-li"><Link to="#">Join the Jumia DA Academy</Link></li>
                        ...
                        <Container className="col-md-3 col-sm-6">
                            ...
                            <ul className="p-0">
                                <li className="f-li"><Link to="#">Sell on Jumia</Link></li>
