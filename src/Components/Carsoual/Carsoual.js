...
export default function Carsoual({products}) {
    ...
    return (
        <>
            <div  id="secondcarsoul" className="carousel slide" data-bs-ride="carousel" >
                ...
                <button className="carousel-control-prev" type="button" data-bs-target="#secondcarsoul" data-bs-slide="prev">
                    <span className="carousel-control-prev-icon" aria-hidden="true" />
                    <span className="visually-hidden">Previous</span>
                </button>


                <button className="carousel-control-next" type="button" data-bs-target="#secondcarsoul" data-bs-slide="next">
